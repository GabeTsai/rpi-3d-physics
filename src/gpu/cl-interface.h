...
typedef enum { 
    ...
    CLIP_WINDOW = 102,
    VIEWPORT_OFFSET = 103,
    Z_MIN_MAX_CLIPPING_PLANES = 104,
    CLIPPER_XY_SCALING = 105,
    CLIPPER_Z_SCALE_AND_OFFSET = 106,
...
#define TILE_STATE_DATA_SIZE 48 // bytes
#define TILE_ALLOC_ENTRY_SIZE 32 // bits
